class Player {
  ...
  generateSprite() {
    const bmd = this.generateCircle(this.color);
  ...
  setColision() {
    ...
    this.sprite.body.collides(
      this.groupColision[2],
      this.particulesCallback,
      this
    );
  }
  ...
  enemyCallback(body1, body2) {
    if (
      body2.sprite.alive &&
      this.sprite.mass - this.sprite.mass * 0.2 > body2.sprite.mass
    ) {
      ...
      this.sprite.alive &&
      body2.sprite.mass - body2.sprite.mass * 0.2 > this.sprite.mass
    ) {
      this.sprite.kill();
